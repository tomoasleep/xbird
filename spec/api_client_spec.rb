...
describe Xbird::ApiClient do
  context "initialization" do
    context "URL stuff" do
      context "host" do
        it "removes http from host" do
          Xbird.configure { |c| c.host = "http://example.com" }
          expect(Xbird::Configuration.default.host).to eq("example.com")
        end

        it "removes https from host" do
          Xbird.configure { |c| c.host = "https://wookiee.com" }
          expect(Xbird::ApiClient.default.config.host).to eq("wookiee.com")
        end

        it "removes trailing path from host" do
          Xbird.configure { |c| c.host = "hobo.com/v4" }
          expect(Xbird::Configuration.default.host).to eq("hobo.com")
        end
      end

      context "base_path" do
        it "prepends a slash to base_path" do
          Xbird.configure { |c| c.base_path = "v4/dog" }
          expect(Xbird::Configuration.default.base_path).to eq("/v4/dog")
        end
        ...
        it "ends up as a blank string if nil" do
          Xbird.configure { |c| c.base_path = nil }
          expect(Xbird::Configuration.default.base_path).to eq("")
        end
      end
    end
  end
  ...
  describe "proxy in #build_connection" do
    let(:config) { Xbird::Configuration.new }
    let(:api_client) { Xbird::ApiClient.new(config) }
    let(:proxy_uri) { URI("http://example.org:8080") }

    it "defaults to nil" do
      expect(Xbird::Configuration.default.proxy).to be_nil
  ...
  describe "#deserialize" do
    it "handles Array<Integer>" do
      api_client = Xbird::ApiClient.new
  ...
  describe "#build_collection_param" do
    ...
    let(:api_client) { Xbird::ApiClient.new }
