...
# Unit tests for Xbird::ConnectionExceptionProblemAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Xbird::ConnectionExceptionProblemAllOf do
  let(:instance) { Xbird::ConnectionExceptionProblemAllOf.new }
  ...
  describe "test an instance of ConnectionExceptionProblemAllOf" do
    it "should create an instance of ConnectionExceptionProblemAllOf" do
      expect(instance).to be_instance_of(Xbird::ConnectionExceptionProblemAllOf)
    end
  end
