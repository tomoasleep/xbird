...
# Unit tests for Xbird::DisallowedResourceProblem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Xbird::DisallowedResourceProblem do
  let(:instance) { Xbird::DisallowedResourceProblem.new }

  describe "test an instance of DisallowedResourceProblem" do
    it "should create an instance of DisallowedResourceProblem" do
      expect(instance).to be_instance_of(Xbird::DisallowedResourceProblem)
    end
  end
