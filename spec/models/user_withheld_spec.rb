...
# Unit tests for Xbird::UserWithheld
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Xbird::UserWithheld do
  let(:instance) { Xbird::UserWithheld.new }

  describe "test an instance of UserWithheld" do
    it "should create an instance of UserWithheld" do
      expect(instance).to be_instance_of(Xbird::UserWithheld)
    end
  end
