...
# Unit tests for Xbird::FieldUnauthorizedProblemAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Xbird::FieldUnauthorizedProblemAllOf do
  let(:instance) { Xbird::FieldUnauthorizedProblemAllOf.new }
  ...
  describe "test an instance of FieldUnauthorizedProblemAllOf" do
    it "should create an instance of FieldUnauthorizedProblemAllOf" do
      expect(instance).to be_instance_of(Xbird::FieldUnauthorizedProblemAllOf)
    end
  end
