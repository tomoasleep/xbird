...
# Unit tests for Xbird::ResourceUnauthorizedProblem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Xbird::ResourceUnauthorizedProblem do
  let(:instance) { Xbird::ResourceUnauthorizedProblem.new }
  ...
  describe "test an instance of ResourceUnauthorizedProblem" do
    it "should create an instance of ResourceUnauthorizedProblem" do
      expect(instance).to be_instance_of(Xbird::ResourceUnauthorizedProblem)
    end
  end
